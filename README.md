...
| <a name="module_role"></a> [role](#module\_role) | cloudposse/iam-role/aws | 1.0.0 |
...
| <a name="input_lambda_runtime"></a> [lambda\_runtime](#input\_lambda\_runtime) | The runtime environment for the Lambda function you are uploading | `string` | `"python3.13"` | no |
...
| <a name="input_log_error_pattern"></a> [log\_error\_pattern](#input\_log\_error\_pattern) | CloudWatch Logs metric filter pattern for errors | `string` | `"Error"` | no |
| <a name="input_metric_namespace"></a> [metric\_namespace](#input\_metric\_namespace) | CloudWatch metric namespace for Lambda error metrics | `string` | `"Custom/Lambda"` | no |
...
| <a name="input_snapshot_source_filter"></a> [snapshot\_source\_filter](#input\_snapshot\_source\_filter) | Restrict triggers to snapshots from a specific origin. One of: "rds", "backup", or null for no filter. | `string` | `null` | no |
...
| <a name="output_cloudwatch_event_rule_ids"></a> [cloudwatch\_event\_rule\_ids](#output\_cloudwatch\_event\_rule\_ids) | The IDs of the CloudWatch event rules |
| <a name="output_cloudwatch_log_group_arn"></a> [cloudwatch\_log\_group\_arn](#output\_cloudwatch\_log\_group\_arn) | The ARN of the CloudWatch log group for the Lambda function |
...
| <a name="output_kms_key_id"></a> [kms\_key\_id](#output\_kms\_key\_id) | The ID of KMS key used by export task |
...
| <a name="output_lambda_role_name"></a> [lambda\_role\_name](#output\_lambda\_role\_name) | The name of the Lambda function IAM role |
